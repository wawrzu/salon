...
INSERT INTO public.appointments OVERRIDING SYSTEM VALUE VALUES (4, 16, '10:30', 1);
...
INSERT INTO public.customers OVERRIDING SYSTEM VALUE VALUES (16, '555-555-5555', 'Fabio');
...
--
-- Name: services services_service_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.services
    ADD CONSTRAINT services_service_key UNIQUE (name);
